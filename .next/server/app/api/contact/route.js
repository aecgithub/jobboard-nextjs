"use strict";(()=>{var e={};e.id=386,e.ids=[386],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2081:e=>{e.exports=require("child_process")},6113:e=>{e.exports=require("crypto")},9523:e=>{e.exports=require("dns")},2361:e=>{e.exports=require("events")},7147:e=>{e.exports=require("fs")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},1808:e=>{e.exports=require("net")},2037:e=>{e.exports=require("os")},1017:e=>{e.exports=require("path")},2781:e=>{e.exports=require("stream")},4404:e=>{e.exports=require("tls")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},9796:e=>{e.exports=require("zlib")},9479:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>x,originalPathname:()=>h,patchFetch:()=>f,requestAsyncStorage:()=>u,routeModule:()=>l,serverHooks:()=>m,staticGenerationAsyncStorage:()=>d,staticGenerationBailout:()=>g});var o={};r.r(o),r.d(o,{POST:()=>c});var a=r(5419),s=r(9108),i=r(9678),n=r(8140),p=r(8984);async function c(e){let{name:t,email:r,subject:o,message:a}=await e.json(),s=[],i=n.createTransport({host:"mail.be-consultancy-group.com",port:465,secure:!0,auth:{user:"info@be-consultancy-group.com",pass:"8z$rY^fH0JbZ"}});try{s=await i.sendMail({from:"info@be-consultancy-group.com",to:"info@be-consultancy-group.com",subject:`Contact form submission from ${new Date().toLocaleString("en-US",{timeZone:"Europe/Madrid"})} `,html:`
          ...
          `})}catch(e){console.log(e)}return p.NextResponse.json(s)}let l=new a.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/contact/route",pathname:"/api/contact",filename:"route",bundlePath:"app/api/contact/route"},resolvedPagePath:"/Users/malin/Projects/nextjs/aec/app/api/contact/route.js",nextConfigOutput:"",userland:o}),{requestAsyncStorage:u,staticGenerationAsyncStorage:d,serverHooks:m,headerHooks:x,staticGenerationBailout:g}=l,h="/api/contact/route";function f(){return(0,i.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:d})}}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),o=t.X(0,[638,234],()=>r(9479));module.exports=o})();