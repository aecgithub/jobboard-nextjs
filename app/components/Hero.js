    ...
    <div className='flex py-10 flex-col-reverse lg:flex-row gap-5'>
        <div className='lg:w-1/2 w-full flex flex-col justify-center items-center lg:items-start'>
            ...
            <div className='flex justify-center w-full '>
              ...
              <p className='text-sm text-center lg:text-left py-4 lg:pr-10 pr-0'>Welcome to BE Consultancy Group, an esteemed consultancy catering to international institutions and organizations. Specializing in IT software consultancy, outsourcing, and staffing services, we excel in providing top-tier IT talent for global entities</p>
